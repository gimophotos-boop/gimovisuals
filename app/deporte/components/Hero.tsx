...
export default function Hero() {
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      >
        <source
          src="/assets/videos/deporte/deporte.mp4"
          type="video/mp4"
        />
      </video>
      ...
      <div className="relative z-10 flex h-full items-center">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="max-w-2xl text-xl text-gray-300 leading-9 mb-10">
            Fotografía y vídeo profesional para clubes, federaciones,
            competiciones, eventos deportivos y deportistas que quieren
            destacar su imagen.
          </p>
