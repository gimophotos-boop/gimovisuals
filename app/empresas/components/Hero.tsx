...
export default function Hero() {
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      >
        <source
          src="/assets/videos/empresas/empresas.mp4"
          type="video/mp4"
        />
      </video>
      ...
      <div className="relative z-10 flex h-full items-center">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="max-w-2xl text-xl text-gray-300 leading-9 mb-10">
            Fotografía, vídeo y contenido audiovisual para empresas,
            restaurantes, hoteles, comercios y marcas que quieren transmitir
