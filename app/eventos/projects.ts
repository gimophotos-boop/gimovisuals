export const projects = [
  {
    title: "Living The Sound 2026",
    location: "La Pobla de Mafumet",
    description: "La mejor forma de disfrutar de la noche de San Juan",
...

  {
    title: "Carnaval 2026",
    location: "La Pobla de Mafumet",
    description: "Así termina la noche de Carnaval",
    video: "/assets/videos/eventos/carnaval-2026/video.mp4",
    href: "/eventos/proyectos/carnaval-2026",
  },

  {
    title: "Pobla Lledó Session 2026",
    location: "La Pobla de Mafumet",
    description: "Disfrutando de las fiestas del Lledó con Alvama Ice",
    video: "/assets/videos/eventos/pobla-lledo-session-2026/video.mp4",
...

  {
    ...
    location: "La Pobla de Mafumet",
    description: "Evento con la mejor música de los años 90 y 2000",
    video: "/assets/videos/eventos/fiesta-remember-2025/video.mp4",
...

  {
    ...
    location: "La Pobla de Mafumet",
    description: "La mejor forma de disfrutar la noche de San Juan",
    video: "/assets/videos/eventos/living-the-sound-2025/video.mp4",
    href: "/eventos/proyectos/living-the-sound-2025",
  },

  {
    title: "Pobla Lledó Session 2025",
    location: "La Pobla de Mafumet",
    description: "Disfrutando las fiestas del Lledó con MonDj",
    video: "/assets/videos/eventos/pobla-lledo-session-2025/video.mp4",
...

  {
    ...
    video: "/assets/videos/eventos/halloween-2024/video.mp4",
...

  {
    ...
    location: "La Pobla de Mafumet",
    description:
      "Disfrutando del evento que mezcla los géneros del Techno y el Flamenco con su creador Marsal Ventura",
    video: "/assets/videos/eventos/techno-flamenco-2024/video.mp4",
...

  {
    ...
    description:
      "Disfrutando del sonido y el color en las noches de Julio en Tarragona",
    video:
      "/assets/videos/eventos/concurso-fuegos-artificiales-tarragona-2026/video.mp4",
