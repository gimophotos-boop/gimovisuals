...
const sesiones = [
  {
    title: "Sesión de embarazo con Verónica",
    href: "/retratos/embarazo/veronica",
  },
  {
    title: "Sesión de embarazo con Lidia",
    href: "/retratos/embarazo/lidia",
  },
];
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="max-w-3xl text-xl text-gray-400 leading-9">
            Sesiones de embarazo pensadas para guardar una etapa única
            y especial.
          </p>
