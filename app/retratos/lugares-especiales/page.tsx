...
const sesiones = [
  {
    title: "Sesión en la ermita con Lidia",
    href: "/retratos/lugares-especiales/lidia-ermita",
  },
  {
    title: "Sesión en el Delta del Ebro con Lucía",
    href: "/retratos/lugares-especiales/lucia-delta",
  },
  {
    title: "Sesión en un parque con Lucía",
    href: "/retratos/lugares-especiales/lucia-parque",
  },
  {
    title: "Sesión en un entorno de patrimonio con Lucía",
    href: "/retratos/lugares-especiales/lucia-patrimonio",
  },
  {
    title: "Sesión en el Puente del Diablo con Lucía",
    href: "/retratos/lugares-especiales/lucia-puente-diablo",
  },
  {
    title: "Sesión en las vías con Lucía",
    href: "/retratos/lugares-especiales/lucia-vias",
  },
  {
    title: "Sesión en la cantera con Olga",
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="max-w-3xl text-xl text-gray-400 leading-9">
            Sesiones realizadas en lugares con personalidad propia,
            donde el entorno forma parte de la historia de cada retrato.
          </p>
