...
const sesiones = [
  ...
  { title: "Kelly", href: "/retratos/playa/kelly", carpeta: "playa/kelly" },
  ...
  { title: "Paola", href: "/retratos/playa/paola", carpeta: "playa/paola" },
  { title: "Rocío", href: "/retratos/playa/rocio", carpeta: "playa/rocio" },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {sesiones.map((sesion, index) => (
              ...
              >
                <Link
                  href={sesion.href}
                  className="group block overflow-hidden rounded-[24px] border border-zinc-700 bg-black/60 backdrop-blur-sm hover:border-red-600 transition duration-500"
                >
                  ...
                  <div className="p-6">
                    ...
                    <h2 className="text-xl md:text-2xl font-black leading-tight px-1 group-hover:text-red-500 transition">
                      {sesion.title}
                    </h2>
